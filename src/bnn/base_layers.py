...
from bnn.distributions import ParametrizedGaussian, ScaleMixtureGaussian, InverseGamma
...
class BayesianLinear(nn.Module):
    ...
    def __init__(
        ...
        # Conditionally create bias parameters
        ...
        # Conditionally create bias prior
        if self.bias_enabled:
    ...
    def forward(
        ...
        # Expand x if necessary and perform matrix multiplication
        x = x.expand(n_samples, -1, -1)
        output = torch.einsum('bij,bkj->bik', x, weight)
